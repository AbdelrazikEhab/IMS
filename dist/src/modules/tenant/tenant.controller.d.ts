...
export declare class TenantController {
    ...
    listCodes(tenantId: string): Promise<{
        id: string;
        tenant_id: string;
        is_active: boolean;
        created_at: Date;
    ...
    createCode(tenantId: string, user: AuthenticatedUser, dto: CreateEnrollmentCodeDto): Promise<{
        id: string;
        tenant_id: string;
        is_active: boolean;
        created_at: Date;
    ...
    deactivateCode(tenantId: string, id: string): Promise<{
        id: string;
        tenant_id: string;
        is_active: boolean;
        created_at: Date;
