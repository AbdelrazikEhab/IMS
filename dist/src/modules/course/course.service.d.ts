...
export declare class CourseService {
    ...
    private readonly courseQueue;
    private readonly videoQueue;
    constructor(prisma: PrismaService, courseQueue: Queue, videoQueue: Queue);
    ...
    create(tenantId: string, teacherId: string, dto: CreateCourseDto): Promise<{
        id: string;
        tenant_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    findById(tenantId: string, courseId: string): Promise<{
        modules: ({
            lessons: {
                id: string;
                tenant_id: string;
    ...
    update(tenantId: string, courseId: string, dto: UpdateCourseDto): Promise<{
        id: string;
        tenant_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    delete(tenantId: string, courseId: string): Promise<void>;
    publish(tenantId: string, courseId: string): Promise<{
        id: string;
        tenant_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    unpublish(tenantId: string, courseId: string): Promise<{
        id: string;
        tenant_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    duplicate(tenantId: string, courseId: string, requesterId: string): Promise<{
        message: string;
    ...
    getVideoUploadUrl(tenantId: string, lessonId: string, filename: string): Promise<{
        uploadId: string;
        tusUrl: string;
        authorizationSignature: string;
        lessonId: string;
    }>;
    getEnrolledStudents(tenantId: string, courseId: string): Promise<({
        student: {
            email: string;
            id: string;
            first_name: string;
